...
$MONGO["servers"][$i]["control_users"]["IH"] = "bdognom";//one of control users ["USERNAME"]=PASSWORD, works only if mongo_auth=false
...
$MONGO["servers"][$i]["ui_hide_system_collections"] = true;//whether hide the system collections
